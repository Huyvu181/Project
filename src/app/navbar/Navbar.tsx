  ...
  return (
    <div  id='Navbar' className="flex items-center justify-between">
      ...
      <div className="flex items-center space-x-4">
        ...
        />
        <div>
          <Link to="/" className="mx-2 hover:text-gray-300" style={{ textDecoration: 'none' }}>About us</Link>
        </div>
        <div>
          <Link to="/" className="mx-2 hover:text-gray-300" style={{ textDecoration: 'none' }}>Shop</Link>
        </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <Link to="/dashboard" className="mx-2 hover:text-gray-300" style={{ textDecoration: 'none' }}>Dashboard</Link>
        </div>
      ...
      <div className="flex items-center space-x-4">
        <div>
          <div>
            <Link to="/profile" className="mx-2 hover:text-gray-300 " style={{ textDecoration: 'none' }}>Profile</Link>
          </div>
          <div>
            <Link to="/" className="mx-2 hover:text-gray-300" style={{ textDecoration: 'none' }}>Search</Link>
          </div>
          <div>
            <Link to="/auth/login" className="mx-2 hover:text-gray-300" style={{ textDecoration: 'none' }}>Sign In</Link>
          </div>
